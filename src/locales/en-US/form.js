export default {
  'form.home.input': 'Input',
  'form.home.search': 'Search',
  'form.home.headline':'TreeHouseData -- DataWarehouse in lots of area',
  'form.get-captcha': 'Get Captcha',
  'form.captcha.second': 'sec',
  'form.optional': ' (optional) ',
  'form.submit': 'Submit',
  'form.save': 'Save',
  'form.email.username': 'Username',
  'form.email.placeholder': 'Email',
  'form.password.placeholder': 'Password, must contain at least 8 characters',
  ...
  'form.date.radio': "Pick a radio",
  'form.date.yearly': "Yearly",
  'form.date.quarterly': "Quarterly",
  'form.date.monthly': "Monthly",
