export default {
  'form.home.input': '输入你想了解的行业数据',
  'form.home.search': '搜索树屋网',
  'form.home.headline':'树屋网--行业数据仓库&查询门户',
  'form.get-captcha': '获取验证码',
  'form.captcha.second': '秒',
  'form.optional': '（选填）',
  'form.submit': '提交',
  'form.save': '保存',
  'form.email.username': '用户名',
  ...
  'form.date.radio': "时间选项",
  'form.date.yearly': "年度",
  'form.date.quarterly': "季度",
  'form.date.monthly': "月度",
  // 'form.date.choice': "时间选项",
